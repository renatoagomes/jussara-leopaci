...
class PostsSeeder extends Seeder
{
    ...
    public function run()
    {
        $post = \App\Models\Post::create([
            ...
            'status' => \App\Models\Post::STATUS_PUBLICADO,
            'preview_post' => 'Baby Blues e Depressão Pós-Parto são termos bastante difundidos nas redes sociais, sites e livros',
            'data_publicacao' => '2018-11-06',
            'autor' => 'Jussara Leopaci',
        ...
        $post->fotoCapa()->create(['cloudinary_id' => 'Texto_01_Depress%C3%A3o_Baby_blues']);
        ...
        $post = \App\Models\Post::create([
            ...
            'preview_post' => 'A produção original Netflix “Bird Box” (2018) que traz Sandra Bullock como atriz principal e S',
            'status' => \App\Models\Post::STATUS_PUBLICADO,
            'conteudo' => '<p>A produção original Netflix “Bird Box” (2018) que traz Sandra Bullock como atriz principal e Susanne Bier na direção, suscitou discussões entre os telespectadores que tentaram revelar os mistérios das simbologias apresentadas no filme. Eu, assim como vários outros, ouvi muito sobre o filme antes de me interessar por ele, mas assumo que o comentário que me cativou foi “estão falando que é sobre maternidade” e foi com esse olhar que assisti e escrevo um pouco do que me provocou nessa temática <a href="#abnt">¹</a>.  </p>
