        ...
        <div class="row mx-auto container-cards">
            ...
            @foreach($Posts as $post)
                <div class="post-card card">
                    ...
                    <div class="card-body">
                        <p>
                        A maternidade é comum a mulher se sentir frágil diante das mudanças corporais, hormonais e incertezas do futuro, ela também revela - da concepção ao... <strong>[leia mais]</strong>
                        </p>
                    </div>
