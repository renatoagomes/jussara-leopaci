...
<div class="d-flex row">
    <div class="col-lg-5 col-md-12">
        <div class="row">
            <div class="col-12">
                <img class="img-fluid" src="http://res.cloudinary.com/tesseract/image/upload/c_scale,q_auto,w_800/v1535989139/jussara/Cl%C3%ADnica_Social_1.jpg" alt="">
            </div>
        </div>
        <div class="row mt-2">
            <div class="col-6">
                <img class="img-fluid" src="http://res.cloudinary.com/tesseract/image/upload/c_scale,h_300,q_auto/v1535989144/jussara/Cl%C3%ADnica_Social_2.jpg" alt="">
            </div>
            <div class="col-6">
                <img class="img-fluid" src="http://res.cloudinary.com/tesseract/image/upload/c_scale,h_300,q_auto/v1535989146/jussara/Cl%C3%ADnica_Social_3.jpg" alt="">
            </div>
        </div>
