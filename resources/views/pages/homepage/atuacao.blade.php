<section id="atuacao" class="">
    <div class="container">
        <div class="text-center pt-4">
            ...
            <h2 class="mt-4 mb-0"> Atuação </h2>
        </div>

        <div class="mt-4 text-center d-flex justify-content-center">
            <ul class="nav nav-tabs d-flex justify-content-between" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab-psicanalitica" role="tab" aria-controls="tab-psicanalitica" aria-selected="true" >CLÍNICA PSICANALÍTICA</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-social" role="tab" aria-controls="social" aria-selected="false">CLÍNICA SOCIAL</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-perinatal" role="tab" aria-controls="perinatal" aria-selected="false">CLÍNICA PERINATAL</a>

                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#tab-eventos" role="tab" aria-controls="eventos" aria-selected="false">EVENTOS</a>
                </li>
            </ul>
        </div>
